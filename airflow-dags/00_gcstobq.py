...
with DAG(
    ...
    schedule='@daily',  # Set as required (e.g., '@daily', '0 12 * * *')
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='etl-airflow-project-data-hafid',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='projetdata-461501.dev_staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
